...
const (
	...
	DirectedEdge_DEL_ALL DirectedEdge_Op = 2
)
...
type Query struct {
	...
	FacetParam   *facetsp.Param      `protobuf:"bytes,8,opt,name=facet_param,json=facetParam" json:"facet_param,omitempty"`
	FacetsFilter *facetsp.FilterTree `protobuf:"bytes,9,opt,name=facets_filter,json=facetsFilter" json:"facets_filter,omitempty"`
}
...
type Mutations struct {
	...
	Schema  []*graphp.SchemaUpdate `protobuf:"bytes,3,rep,name=schema" json:"schema,omitempty"`
}
...
func (m *Mutations) GetSchema() []*graphp.SchemaUpdate {
	if m != nil {
		return m.Schema
	}
	return nil
...
func (m *Mutations) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Schema = append(m.Schema, &graphp.SchemaUpdate{})
...
var fileDescriptorTask = []byte{
	...
	,
}
